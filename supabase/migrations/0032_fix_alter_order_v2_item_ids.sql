-- Migration: 0032_fix_alter_order_v2_item_ids.sql
-- Description: Make alter_order_v2 always generate new order_items IDs to avoid PK clashes
-- Dependencies: 0030_add_is_edited_to_orders.sql
...
BEGIN
    ...
    LOOP
        ...
        VALUES (
            gen_random_uuid(), -- always generate a fresh ID to avoid PK collisions
            v_new_order_id,
            item->>'sku',
